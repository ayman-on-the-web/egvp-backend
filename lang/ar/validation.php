...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'volunteer' => 'المتطوع',
        'volunteer_id' => 'المتطوع',
        'event_category' => 'التصنيف',
        'event_category_id' => 'التصنيف',
        'application' => 'طلب التطوع',
        'application_id' => 'طلب التطوع',
        'attendance' => 'تسجيل الحضور',
        'attendance_id' => 'تسجيل الحضور',
        'rating' => 'التقييم',
        'rating_id' => 'التقييم',
        'status' => 'الحالة',
        'is_approved' => 'خانة الموافقة',
        'hours' => 'عدد الساعات',
        'points' => 'النقاط',
        'start_date' => 'تاريخ البداية',
        'end_date' => 'تاريخ النهاية', 
        'target_hours' => 'عدد الساعات المطلوب',
        'address' => 'العنوان',
        'city' => 'المدينة',
        'country' => 'الدولة',
        'image_base64' => 'الصورة',
        'name' => 'الاسم',
        'is_active' => 'خانة الحالة',
        'active_until' => 'نشط حتى تاريخ',
